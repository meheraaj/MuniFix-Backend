...
describe("createComplaint image streaming & AI fallback", () => {
  it("should upload image buffers and handle Gemini AI classification failure", async () => {
    process.env.GEMINI_API_KEY = "mock_api_key";

    req.user_id = "citizen-99";
    req.body = { description: "Water clogging on main street drain" };
    req.files = [
      {
